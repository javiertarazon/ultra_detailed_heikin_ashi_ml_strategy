...
class UltraDetailedHeikinAshiML2Strategy:
    ...
    def run(self, data: pd.DataFrame, symbol: str, timeframe: str = '4h') -> Dict:
        ...
        try:
            ...
            model_exists = self.ml_manager.load_model(symbol, 'neural_network_advanced')[0] is not None  # RED NEURONAL AVANZADA v2
            ...
            ml_confidence_cached = self.ml_manager.predict_signal(data_processed, symbol, 'neural_network_advanced')  # RED NEURONAL AVANZADA v2
