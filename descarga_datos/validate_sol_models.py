#!/usr/bin/env python3
"""
Script para validar que los modelos ML de SOL/USDT se pueden cargar correctamente
"""
...
def validate_sol_models():
    """Valida que los modelos de SOL/USDT se pueden cargar correctamente"""

    logger.info("=== VALIDACION DE MODELOS SOL/USDT ===")

    # Directorio de modelos SOL/USDT
    models_dir = Path(__file__).parent / "models" / "SOL_USDT"
